...
print(f"The total number of loans is: {total_number_of_loans} loans")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
total_loan_amount = sum(loan_costs)
print(f"The total value of the loans is ${total_loan_amount} ")
...
if present_value >= loan_cost:
    print(f"The loan of amount ${loan_cost} is worth at least the cost of ${present_value:.2f} to buy it.")
else:
    print(f"The loan of amount ${loan_cost} is too expensive and not worth the price of ${present_value:.2f}.")
...
present_value = calculate_present_value(future_value, remaining_months, 0.2)
